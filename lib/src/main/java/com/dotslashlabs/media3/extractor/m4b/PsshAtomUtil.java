...
public final class PsshAtomUtil {
  ...
  public static byte[] buildPsshAtom(
    ...
    int psshBoxLength = com.dotslashlabs.media3.extractor.m4b.Atom.FULL_HEADER_SIZE + 16 /* SystemId */ + 4 /* DataSize */ + dataLength;
    if (keyIds != null) {
      psshBoxLength += 4 /* KID_count */ + (keyIds.length * 16) /* KIDs */;
    }
    ByteBuffer psshBox = ByteBuffer.allocate(psshBoxLength);
    psshBox.putInt(psshBoxLength);
    psshBox.putInt(com.dotslashlabs.media3.extractor.m4b.Atom.TYPE_pssh);
  ...
  private static PsshAtom parsePsshAtom(byte[] atom) {
    ...
    if (atomData.limit() < com.dotslashlabs.media3.extractor.m4b.Atom.FULL_HEADER_SIZE + 16 /* UUID */ + 4 /* DataSize */) {
      // Data too short.
      return null;
    }
    ...
    if (atomType != com.dotslashlabs.media3.extractor.m4b.Atom.TYPE_pssh) {
      // Not an atom, or incorrect atom type.
      return null;
    }
    int atomVersion = com.dotslashlabs.media3.extractor.m4b.Atom.parseFullAtomVersion(atomData.readInt());
    if (atomVersion > 1) {
