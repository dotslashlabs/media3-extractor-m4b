...
public final class Track {
  ...
  @Nullable private final com.dotslashlabs.media3.extractor.m4b.TrackEncryptionBox[] sampleDescriptionEncryptionBoxes;
  ...
  public Track(
      ...
      @Nullable com.dotslashlabs.media3.extractor.m4b.TrackEncryptionBox[] sampleDescriptionEncryptionBoxes,
  ...
  /**
   * Returns the {@link com.dotslashlabs.media3.extractor.m4b.TrackEncryptionBox} for the given sample description index.
   *
   * @param sampleDescriptionIndex The given sample description index
   * @return The {@link com.dotslashlabs.media3.extractor.m4b.TrackEncryptionBox} for the given sample description index. Maybe null if no
   *     such entry exists.
   */
  @Nullable
