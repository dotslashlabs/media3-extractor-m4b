...
/* package */ final class MetadataUtil {
  ...
  private static final int TYPE_COPYRIGHT = 0x63707274;
  ...
  public static Metadata.Entry parseIlstElement(ParsableByteArray ilst) {
    ...
    try {
      ...
      } else if (type == TYPE_COPYRIGHT) {
        return parseTextAttribute(type, "TCR", ilst);
      ...
      Log.d(TAG, "Skipped unknown metadata entry: " + com.dotslashlabs.media3.extractor.m4b.Atom.getAtomTypeString(type));
      return null;
    } finally {
  ...
  public static MdtaMetadataEntry parseMdtaMetadataEntryFromIlst(
    ...
    while ((atomPosition = ilst.getPosition()) < endPosition) {
      ...
      if (atomType == com.dotslashlabs.media3.extractor.m4b.Atom.TYPE_data) {
  ...
  private static TextInformationFrame parseTextAttribute(
    ...
    Log.w(TAG, "Failed to parse text attribute: " + com.dotslashlabs.media3.extractor.m4b.Atom.getAtomTypeString(type));
    return null;
  }
  ...
  private static CommentFrame parseCommentAttribute(int type, ParsableByteArray data) {
    ...
    Log.w(TAG, "Failed to parse comment attribute: " + com.dotslashlabs.media3.extractor.m4b.Atom.getAtomTypeString(type));
    return null;
  }
  ...
  private static Id3Frame parseUint8Attribute(
    ...
    Log.w(TAG, "Failed to parse uint8 attribute: " + com.dotslashlabs.media3.extractor.m4b.Atom.getAtomTypeString(type));
    return null;
  }
  ...
  private static TextInformationFrame parseIndexAndCountAttribute(
    ...
    int atomSize = data.readInt();
    int atomType = data.readInt();
    if (atomType == com.dotslashlabs.media3.extractor.m4b.Atom.TYPE_data && atomSize >= 22) {
    ...
    Log.w(TAG, "Failed to parse index/count attribute: " + com.dotslashlabs.media3.extractor.m4b.Atom.getAtomTypeString(type));
    return null;
  }
  ...
  private static ApicFrame parseCoverArt(ParsableByteArray data) {
    ...
    if (atomType == com.dotslashlabs.media3.extractor.m4b.Atom.TYPE_data) {
      ...
      int flags = com.dotslashlabs.media3.extractor.m4b.Atom.parseFullAtomFlags(fullVersionInt);
  ...
  private static Id3Frame parseInternalAttribute(ParsableByteArray data, int endPosition) {
    ...
    while (data.getPosition() < endPosition) {
      ...
      if (atomType == com.dotslashlabs.media3.extractor.m4b.Atom.TYPE_mean) {
        domain = data.readNullTerminatedString(atomSize - 12);
      } else if (atomType == com.dotslashlabs.media3.extractor.m4b.Atom.TYPE_name) {
