...
import static com.dotslashlabs.media3.extractor.m4b.AtomParsers.parseTraks;
...
@UnstableApi
public final class M4bExtractor implements Extractor, SeekMap {

  /** Factory for {@link M4bExtractor} instances. */
  public static final ExtractorsFactory FACTORY = () -> new Extractor[] {new M4bExtractor()};
   ...
   */
  public M4bExtractor(@Flags int flags) {
    this.flags = flags;
    parserState =
  ...
  private void processMoovAtom(Atom.ContainerAtom moov) throws ParserException {
    ...
    if (udta != null) {
      ...
      chplMetadata = udtaInfo.chplMetadata;
    ...
    for (int i = 0; i < trackCount; i++) {
      ...
      MetadataUtil.setFormatMetadata(
          ...
          mvhdMetadata,
          chplMetadata,
          new Metadata(new MediaMetadataFrame(durationUs, fileType)));
