...
/* package */ final class Sniffer {
  ...
  private static boolean sniffInternal(ExtractorInput input, boolean fragmented, boolean acceptHeic)
    ...
    while (bytesSearched < bytesToSearch) {
      // Read an atom header.
      int headerSize = com.dotslashlabs.media3.extractor.m4b.Atom.HEADER_SIZE;
      ...
      if (atomSize == com.dotslashlabs.media3.extractor.m4b.Atom.DEFINES_LARGE_SIZE) {
        // Read the large atom size.
        headerSize = com.dotslashlabs.media3.extractor.m4b.Atom.LONG_HEADER_SIZE;
        input.peekFully(
            buffer.getData(), com.dotslashlabs.media3.extractor.m4b.Atom.HEADER_SIZE, com.dotslashlabs.media3.extractor.m4b.Atom.LONG_HEADER_SIZE - com.dotslashlabs.media3.extractor.m4b.Atom.HEADER_SIZE);
        buffer.setLimit(com.dotslashlabs.media3.extractor.m4b.Atom.LONG_HEADER_SIZE);
        atomSize = buffer.readLong();
      } else if (atomSize == com.dotslashlabs.media3.extractor.m4b.Atom.EXTENDS_TO_END_SIZE) {
      ...
      if (atomType == com.dotslashlabs.media3.extractor.m4b.Atom.TYPE_moov) {
      ...
      if (atomType == com.dotslashlabs.media3.extractor.m4b.Atom.TYPE_moof || atomType == com.dotslashlabs.media3.extractor.m4b.Atom.TYPE_mvex) {
      ...
      if (atomType == com.dotslashlabs.media3.extractor.m4b.Atom.TYPE_ftyp) {
